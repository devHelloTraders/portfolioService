...
import com.traders.portfolio.domain.User;
...
public class portfolioMapper {}/*{
    ...
    public List<PortfolioDTO> portfolioToPortfolioDTO(List<User> users) {
        return users.stream().filter(Objects::nonNull).map(this::userToUserDTO).toList();
    }

    public PortfolioDTO userToUserDTO(User user) {
        return new PortfolioDTO(user);
    }
